 ...
 * Update 2017, Denisov Andrey © AD Soft
 * added meta-atribute data-icon="full_file_name.jpg"
 * Fork in https://github.com/ADSoftTeam/easydropdown
 */
(function(d) {
    function e() {
        this.isField = !0;
    ...
    e.prototype = {
        ...
        init: function(a, c) {
            ...
            b.$options.length && (b.$options.each(function(a) {
                ...
                c.is(":selected") && (b.selected = {
                    index: a,					
                    title: c.text(),
					icon: (typeof c.attr("data-icon") !== 'undefined' ? '<img src="'+c.attr("data-icon")+'" />' : "")
                }, b.focusIndex = a);
        ...
        render: function() {
            ...
            a.$active = d('<span class="selected">' + a.selected.icon + a.selected.title + "</span>").appendTo(a.$container);
            ...
            d.each(a.options, function() {
                a.$dropDown.append("<li" + (this.selected ? ' class="active"' : "") + ">" + this.icon +this.title + "</li>")
            });
        ...
        select: function(a) {
			...
			var icon = (typeof this.$select.find("option:selected").attr("data-icon") !== 'undefined' ? '<img src="'+this.$select.find("option:selected").attr("data-icon")+'" />' : "");
			this.$active.html(icon+c.title);			
